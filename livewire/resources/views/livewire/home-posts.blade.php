<div>
    ...
    <div class="flex flex-col bg-white px-8 py-6 max-w-sm mx-auto rounded-lg shadow-lg">
        <div class="flex justify-center items-center">
            <a class="px-2 py-1 bg-gray-600 text-sm text-green-100 rounded" href="{{ url("post/$post->slug") }}">Laravel</a>
        </div>
        <div class="mt-4">
            <a class="text-lg text-gray-700 font-medium" href="#">{{ $post->title }}</a>
        </div>
